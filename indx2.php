...
function addspeech() {
    ...
    speechmas.push('Вопрос №'+z+'.'+document.reg.ste1.value+". "+document.reg.ste2.value+'\n\n');
 z++;
}
</script>
</head>
...
Введите ID <input text="text" id="id" name="id" />
    <br>povestka<br><div id="aim"></div>
 ...
 <div class="modal-body">
  <input type="text" id="step" placeholder="Введите степень">
 </div>
 <div class="modal-footer">
   <button type="button" id="close" data-dismiss="modal" onClick="add()" >Посчитать</button>
 </div>
    </div>
   </div>
</div>
 ...
 <div class="modal-footer">
   <button type="button" id="close" data-dismiss="modal" onClick="addspeech()" >Посчитать</button>
 </div>
    </div>
   </div>
</div>
     resheniya<br><div id="sol"></div>
            <input value="Добавить resh" type="button" size="200" href="#mini-modal-window3" data-toggle="modal">
  <div id="mini-modal-window3" class="modal fade">
   <div class="modal-dialog">
    <div class="modal-content">
 <div class="modal-body">
  <input type="text" id="step2" placeholder="Введите степень">
 </div>
 <div class="modal-footer">
   <button type="button" id="close2" data-dismiss="modal" onClick="soladd()" >Посчитать</button>
 </div>
    </div>
   </div>
</div>
 ...
 <input type="checkbox" checked name="member" value="asd" />доц. Карпова Н.А.
